...
describe("AfterPush.deliveries", () => {
  ...
  it.effect("waits at the end for work that is still running", () =>
    Effect.promise(async () => {
  ...
  it.effect("interrupts a receiver that never answers rather than only stopping waiting", () =>
    Effect.promise(async () => {
  ...
  it.effect("waits for work that starting the work started", () =>
    Effect.promise(async () => {
  ...
  it.effect("keeps a failing delivery to itself", () =>
    Effect.promise(async () => {
...
describe("AfterPush.collected", () => {
  ...
  it.effect("sends nothing when the verb wrote nothing", () =>
    Effect.promise(async () => {
      const sent: Array<ReadonlyArray<ReceiveResult>> = [];
      const held = collected(recording(sent));
  ...
  it.effect("flushes without a chain ever having been built", () =>
    Effect.promise(async () => {
  ...
  it.effect("asks a refusal while it can still refuse", () =>
    Effect.promise(async () => {
