...
describe("Snapshot", () => {
  it("captures the refs and answers them back as a read-only store", async () => {
  ...
  it("judges anonymous readability from the trust state at capture time", async () => {
  ...
  it("serves a real clone from the snapshot and the objects, with no writer", async () => {
