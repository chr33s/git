...
describe("routeOf", () => {
  ...
  it.effect("strips a trailing .git, so both spellings are one repository", () =>
    Effect.sync(() => {
  ...
  it.effect("strips only the suffix", () =>
    Effect.sync(() => {
  ...
  it.effect("keeps the tail intact", () =>
    Effect.sync(() => {
  ...
  it.effect("rejects what cannot be a storage key", () =>
    Effect.sync(() => {
...
describe("normalize", () => {
  it.effect("rewrites the path to the stripped spelling", () =>
    Effect.sync(() => {
  ...
  it.effect("returns the same request when there is nothing to rewrite", () =>
    Effect.sync(() => {
  ...
  it.effect("preserves method and headers", () =>
    Effect.sync(() => {
