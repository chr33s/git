...
describe("the per-repository gate", () => {
  ...
  it.effect("still lets a collection run once the reader has gone", () =>
    Effect.promise(async () => {
...
describe("starting up", () => {
  it.effect("reports a port it cannot bind instead of dying on it", () =>
    Effect.promise(async () => {
...
describe("a memoised router", () => {
  it.effect("judges every request as whoever made it, not as the first caller", () =>
    Effect.promise(async () => {
...
describe("a mirror beside its origin", () => {
  it.effect("does not answer for the repository next to it", () =>
    Effect.promise(async () => {
      const origin = "origin";
...
describe("the administrative registries", () => {
  it.effect("does not administer a repository nobody opened, identity or not", () =>
    Effect.promise(async () => {
  ...
  it.effect("does not show a reader where this repository sends things", () =>
    Effect.promise(async () => {
...
describe("a remote configured to be sent to", () => {
  it.effect("gets what a push landed, without anybody asking", () =>
    Effect.promise(async () => {
