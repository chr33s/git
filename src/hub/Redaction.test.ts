...
describe("hub redaction", () => {
  it.effect("removes a packed payload that reachability would otherwise protect", () =>
  ...
  it.effect("removes a prompt a session should never have carried", () =>
    Effect.promise(async () => {
  ...
  it.effect("ignores a tombstone from a signer who never held hub.redact", () =>
    Effect.promise(async () => {
  ...
  it.effect("lets a fetch plan the pull request whose payload was redacted", () =>
    Effect.promise(async () => {
  ...
  it.effect("keeps a redacted payload the source history also holds", () =>
    Effect.promise(async () => {
  ...
  it.effect("keeps one the source history reaches only through a reflog", () =>
    Effect.promise(async () => {
  ...
  it.effect("does not drop a redacted oid a fetch's own trees still need", () =>
    Effect.promise(async () => {
  ...
  it.effect("says the same thing on a dry run as on the run it predicts", () =>
    Effect.promise(async () => {
  ...
  it.effect("keeps honouring a tombstone after the redactor is revoked", () =>
    Effect.promise(async () => {
  ...
  it.effect("keeps honouring a tombstone after the redactor's grant has expired", () =>
    Effect.promise(async () => {
  ...
  it.effect("explains an absence a replica cannot yet authorize", () =>
    Effect.promise(async () => {
  ...
  it.effect("works the covered set out once per repository state", () =>
    Effect.promise(async () => {
  ...
  it.effect("steps over a commit whose tree never arrived", () =>
    Effect.promise(async () => {
  ...
  it.effect("does not honour a tombstone that records no trust head", () =>
    Effect.promise(async () => {
  ...
  it.effect("will not let an expired holder start an irreversible deletion", () =>
    Effect.promise(async () => {
  ...
  it.effect("keeps collecting when one pull request will not fold", () =>
    Effect.promise(async () => {
      ...
      assert.equal(
        outcome,
        0,
        "the set is empty because neither folded, and not because it failed",
      );
    }),
  );

  it.effect("passes over a pull request this replica cannot walk", () =>
    Effect.promise(async () => {
  ...
  it.effect("excludes nothing in a repository that has no genesis", () =>
    Effect.promise(async () => {
  ...
  it.effect("keeps a payload no tombstone covers", () =>
    Effect.promise(async () => {
      const outcome = await scenario(
        Effect.gen(function* () {
          const repository = yield* Repository;
