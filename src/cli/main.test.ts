...
describe("cli", () => {
  ...
  it.effect("answers git's credential helper protocol on stdin", () =>
    Effect.promise(async () => {
      ...
      try {
        ...
        try {
          ...
          const allowed = await fetch(`${server.url}/helped/info/refs?service=git-upload-pack`, {
            headers: {
              authorization: `Basic ${btoa(`x:${await asked(new URL(server.url).host)}`)}`,
            },
          });
  ...
  it.effect("says what to do when asked for a credential on a repository with no genesis", () =>
    Effect.promise(async () => {
  ...
  it.effect("clones over smart HTTP, with and without a credential", () =>
    Effect.promise(async () => {
  ...
  it.effect("fetches and pulls a remote's movement into a clone", () =>
    Effect.promise(async () => {
  ...
  it.effect("serves a repository with a genesis only to its members", () =>
    Effect.promise(async () => {
  ...
  it.effect("inspects a repository: branch, tag, show, files, grep, diff", () =>
    Effect.promise(async () => {
  ...
  it.effect("pushes to a server and exports an archive", () =>
    Effect.promise(async () => {
  ...
  it.effect("checks integrity and collects garbage", () =>
    Effect.promise(async () => {
...
describe("the bin entry", () => {
  ...
  it.effect("fills a compile cache that main.ts alone does not", () =>
    Effect.promise(async () => {
