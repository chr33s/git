...
describe("ref names", () => {
  ...
  it("refuses names that address something other than a ref", () => {
    for (const name of [
      "",
      "HEAD",
      "config",
  ...
  it("refuses names git's own check-ref-format refuses", () => {
    for (const name of [
  ...
  it("lets a name it would not create still be deleted", async () => {
