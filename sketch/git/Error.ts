...
export class RefConflict extends Schema.TaggedError<RefConflict>()("RefConflict", {
  ref: Schema.String,
...
export class PackCorrupt extends Schema.TaggedError<PackCorrupt>()("PackCorrupt", {
...
export class HookRejected extends Schema.TaggedError<HookRejected>()("HookRejected", {
